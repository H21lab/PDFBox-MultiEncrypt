/*
 * 2015, Modified by Martin Kacer, code based on PDFBox library
 *
...
public class MultiEncrypt
{
    ...
    {
        MultiEncrypt encrypt = new MultiEncrypt();
                ...
                if( !document.isEncrypted() )
                {
                    if( certFiles.size() > 0 )
                    {
                    	...
                    	for (int i = 0; i < certFiles.size(); i++) {
                             ...
                             InputStream inStream = new FileInputStream(certFiles.get(i));
    ...
    private static void usage()
    {
        ...
        System.err.println( "   -keyLength <length>                      The length of the key in bits(128)" );
